 ...
 */
class Pdf_Doc_Encoding
{
    public static function get_code_page(): array
    {
        return [
            "\x18" => "˘",
            // breve
    ...
    public static function convert_pdf_doc2utf8(string $content): string
    {
        return strtr($content, static::get_code_page());
    }
}